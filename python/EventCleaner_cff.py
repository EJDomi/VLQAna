...
evtcleaner = cms.EDFilter("EventCleaner",
    ...
    File_PUDistData            = cms.string('RunII2016_PUXsec63000nb.root'),
    File_PUDistDataLow         = cms.string('RunII2016_PUXsec59550nb.root'),
    File_PUDistDataHigh        = cms.string('RunII2016_PUXsec66450nb.root'),
